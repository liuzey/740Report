...
pretrained_model = "/scratch/z119l510/finetune_AlexNet_ResNet/"
use_cuda=True

model = load_model(name='alexnet')

# MNIST Test dataset and dataloader declaration
test_loader = data_loader.load_data(
        '/scratch/z119l510/finetune_AlexNet/data/Original_images/','webcam', batch_size=1, 'tar')
